...
class BookingClass:
    ...
    def __get_database_schema_string(self):
        ...
        TOOLS = [
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "Retrieves specific fare rules and refund amount to determine applicable refund amounts.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "query": {
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "refund_amount": {
                                "type": "number",
                                "description": "The amount with 1 decimal place to refund."
                            }
                        },
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "Processes flight rebooking without any fees, subject to availability.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "booking_reference": {"type": "string", "description": "Customer's booking reference."},
                            "new_flight": {"type": "string", "description": "Flight code for the new flight."}
                        },
                        "required": ["booking_reference"],
                        "additionalProperties": False
                    }
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "Applies necessary change fees and any fare differences after rebooking.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "booking_reference": {"type": "string", "description": "Customer's booking reference."}
            ...
            },
            {
                ...
                "function": {
                    "name": "book_flight",
                    "description": "Books the customer on the specified flight. New flights only.",
                    "parameters": {
                        "type": "object",
                        "properties": {
    ...
    def get_booking_function_tools(self):
        self.__get_database_schema_string()
        return self.__get_tools_list()